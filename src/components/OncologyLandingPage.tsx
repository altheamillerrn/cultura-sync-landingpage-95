      ...
      <section className="relative pt-12 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="h-32 sm:h-40 lg:h-48 flex items-center justify-center mb-8 p-4">
              <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/10">
                <img 
                  ...
                  className="h-full w-auto max-w-sm sm:max-w-md lg:max-w-lg object-contain hover:scale-105 transition-transform duration-300 filter drop-shadow-lg"
                />
              </div>
            </div>
          </div>
